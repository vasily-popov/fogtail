...
import com.vascome.fogtail.integrationTests.api.FogtailRestApiIntegrationTest
import com.vascome.fogtail.integrationTests.api.entities.RecAreaItemTest
...
class FogtailIntegrationTestApp : FogtailApplication() {
    ...
    @Singleton
    @Component(modules = arrayOf(ApplicationModule::class, IntegrationTestModule::class, MockAnalyticsModule::class, OkHttpInterceptorsModule::class, DeveloperSettingsModule::class, AndroidSupportInjectionModule::class))
