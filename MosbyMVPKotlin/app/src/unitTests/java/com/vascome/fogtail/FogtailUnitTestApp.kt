...
class FogtailUnitTestApp : FogtailApplication() {
    ...
    @Singleton
    @Component(modules = [(ApplicationModule::class), (IntegrationTestModule::class), (MockAnalyticsModule::class), (OkHttpInterceptorsModule::class), (DeveloperSettingsModule::class), (AndroidSupportInjectionModule::class)])
