...
class AnalyticsModule {
    ...
    internal class GoogleFirebaseAppAnalytics
    @Inject constructor(private val app:Application):AnalyticsModel {
    ...
    internal class FlurryAppAnalytics(app: NonNull) : AnalyticsModel {
        ...
        fun sendEvent(eventName: NonNull) {

            FlurryAgent.logEvent(eventName)
        }

        fun sendError(message: NonNull, error: NonNull) {
