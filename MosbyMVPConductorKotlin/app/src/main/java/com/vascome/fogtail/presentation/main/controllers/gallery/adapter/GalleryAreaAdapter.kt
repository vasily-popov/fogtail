package com.vascome.fogtail.presentation.main.controllers.gallery.adapter
...
internal class GalleryAreaAdapter(private val layoutInflater: LayoutInflater,
                         private val imageLoader: AppImageLoader,
                         private val collectionAreaItemListener: CollectionAreaItemListener) : RecyclerView.Adapter<GalleryAreaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(layoutInflater.inflate(R.layout.gallery_item, parent, false), imageLoader)
    }

    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        viewHolder.bind(items[position])
        viewHolder.itemView.setOnClickListener { _ -> collectionAreaItemListener.onItemClick(items[position]) }
    }
